	...
	return (
		<div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
			...
			<div className="col-span-2 relative aspect-square">
				{/* if we can't import the image, like a image from a database and we want it to be responsive, without fixed width and height */}
				{/* by fill and cover the parent element, we can set the aspect ratio of the parent element to get the size we want */}
				<Image
					src="/about-2.jpg"
					fill
